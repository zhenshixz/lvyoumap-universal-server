...
function injectPanel(html) {
  ...
  const preferredNames = ['北京鹫峰国家森林公园', '安顺场景区', '褒禅山景区', '将军关探险漂流', '南通植物园', '己略黄公祠'];
  for (const name of preferredNames) {
    const item = manifest.items.find(value => value.name === name);
