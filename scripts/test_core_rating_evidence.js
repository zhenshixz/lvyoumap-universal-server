...
const { applyRatingFallback, liveAmapRating, localAmapRating, sameRatingIdentity } = require('./core_rating_evidence');
...
assert.strictEqual(liveAmapRating(
  { name: '恭王府景区', city: '北京' },
  [{ id: 'B1', name: '恭王府景区', cityname: '北京市', business: { rating: '4.8' } }],
).rating, 4.8, '高德 Web 服务 business.rating 应绑定唯一同实体 POI');
assert.strictEqual(liveAmapRating(
  { name: '八达岭—慕田峪长城旅游区', city: '北京' },
  [{ id: 'B2', name: '八达岭长城', cityname: '北京市', business: { rating: '4.9' } }],
