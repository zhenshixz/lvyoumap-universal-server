Vue.createApp({
  data: () => ({ page: location.hash.slice(1) || 'form', form: null, batches: [], drafts: [], historyId: '', count: 10, selected: '', batch: null, error: '', message: '', saving: false, dirty: false, polling: false, busy: false, choices: {}, covers: {}, choiceBatch: '' }),
  computed: {
